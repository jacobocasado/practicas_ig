...
class CaraAdelante : public NodoGrafoEscena{
public:
    CaraAdelante();
};

class CaraAbajo : public NodoGrafoEscena{
public:
    CaraAbajo();
};

class CaraIzquierda : public NodoGrafoEscena{
public:
    CaraIzquierda();
};

class CuboMovimiento : public NodoGrafoEscena{
public:
    CuboMovimiento(float angulo);
};
